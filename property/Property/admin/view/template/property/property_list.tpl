 ...
 <div class="panel panel-default">
      ...
      <div class="panel-body">
			...
			<div class="col-sm-3">
				...
				<input type="text" name="filter_name" value="" placeholder="<?php echo $filterlablel_name; ?>" id="input-name" class="form-control" />
				</div>
			</div> 
			<div class="col-sm-3">
				<div class="form-group">
					...
					<input type="text" name="filter_price_from" value="" placeholder="<?php echo $filterlablel_price_range; ?>" id="input-sort_order" class="form-control" />
				</div>
			</div>
			<div class="col-sm-3">
				<div class="form-group">
				...
				<input type="text" name="filter_price_to" value="" placeholder="<?php echo $filterlablel_price_from; ?>" id="input-sort_order" class="form-control" />
			</div>
			...
			<div class="form-group">
					...
					<input type="text" name="filter_agent" value="" placeholder="<?php echo $filterlablel_agent; ?>" id="input-name" class="form-control" />
			...
			<div class="col-sm-3">
				<div class="form-group">
					...
					<input type="text" name="filter_propertystatus" value="" placeholder="<?php echo $filterlablel_property_status; ?>" id="input-name" class="form-control" />
