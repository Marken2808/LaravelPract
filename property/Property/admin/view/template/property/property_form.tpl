								...
								<div class="tab-pane" id="2a">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label"><?php echo $lable_image; ?></label>
											<div class="col-sm-10"><a href="" id="thumb-image" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb; ?>" alt="" title="" placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="image" value="<?php echo $image; ?>" id="inputimage" />
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label" for="input-pricelabel"><?php echo $lable_pricelabel; ?></label>
										<div class="col-sm-10">
							...
							<!--select options -->
								...
								<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" name="lenght" value="<?php echo $lenght;?>" placeholder="<?php echo $entry_arealenght;?>" id="input-package-title" class="form-control"/>
										</div>
									</div>
									<div class="form-group">
