...
class ModelPropertyMail extends Model {
	...
	public  function getMailInfo($growertype){
		$query=$this->db->query("select * from " . DB_PREFIX . "mail vm LEFT JOIN " . DB_PREFIX . "mail_language vml on(vm.mail_id=vml.mail_id) where vm.growertype='" .$growertype."'and vml.language_id = '" . (int)$this->config->get('config_language_id') . "'");
