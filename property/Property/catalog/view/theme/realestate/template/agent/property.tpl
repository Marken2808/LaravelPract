			...
			<div class="panel-body">
				<form method="post" enctype="multipart/form-data" id="form-information" class="form-horizontal">
					...
					<legend><?php echo $tab_data; ?></legend>			
						...
						<div class="form-group">
							<label class="col-sm-2 control-label" for="input-pricelabel"><?php echo $text_pricelabel; ?></label>
							<div class="col-sm-10">
						...
						<legend><?php echo $tab_Address_Map; ?></legend>			
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-area"><?php echo $text_area; ?></label>
								<div class="col-sm-4">
