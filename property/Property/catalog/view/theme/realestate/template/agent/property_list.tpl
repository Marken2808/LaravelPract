			...
			<div class="row">
				<div class="col-sm-4">
					<div class="form-group">
						<label class="control-label" for="input-name"><?php echo $filter_name; ?></label>
						<input type="text" name="filter_name" value="" placeholder="<?php echo $filter_name; ?>" id="input-name" class="form-control" />
					</div>
				</div> 
				<div class="col-sm-4">
					<div class="form-group">
						<label class="control-label" for="input-sort_order">
						<?php echo $filter_price_range; ?></label>
						<input type="text" name="filter_price_from" value="" placeholder="<?php echo $filter_price_range; ?>" id="input-sort_order" class="form-control" />
					</div>
				</div>
				<div class="col-sm-4">
					<div class="form-group">
						<label class="control-label" for="input-sort_order">
						<?php echo $filter_price_from; ?></label>
						<input type="text" name="filter_price_to" value="" placeholder="<?php echo $filter_price_from; ?>" id="input-sort_order" class="form-control" />
					</div>
				</div>
				<div class="col-sm-4">
					<div class="form-group">
						<label class="control-label" for="input-status"><?php echo $filter_status; ?></label>
						<select name="filter_status" id="input-status" class="form-control">
							<option value=""><?php echo $filter_select;?></option>
							<option value="1"><?php echo $filter_enable; ?></option>
							<option value="0"><?php echo $filter_disable; ?></option>
						</select>
					</div>
				</div>
				<div class="col-sm-4">
