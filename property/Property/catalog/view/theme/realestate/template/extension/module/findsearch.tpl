		...
		<div class="row form-group">
			<div class="col-sm-12 col-xs-12">
				...
				<input type="hidden" name="route" value="property/category" />
					<input type="text" class="range_1" />
				</div>
			</div>
			
			<div class="col-sm-12 col-xs-12">	
				<label><?php echo $findproperty_area;?>(<span class="sub"><?php echo $findproperty_SqFt;?></span>)</label>
				<div class="attribute price-filter">
					<input type="hidden" name="route" value="property/category" />
...
<script type="text/javascript" src="catalog/view/javascript/jquery/check.js"></script>
<script type="text/javascript" src="catalog/view/javascript/jquery/preetycheble/prettyCheckable.min.js"></script>
<link href="catalog/view/javascript/jquery/preetycheble/prettyCheckable.css" rel="stylesheet"/>
